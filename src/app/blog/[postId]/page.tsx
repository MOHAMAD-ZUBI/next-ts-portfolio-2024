    ...
    return (
        <main className="text-white min-h-screen bg-main-page main-page-specific">
            ...
            <article className="mt-[50px] md:text-lg flex justify-center items-center flex-col ">
                <section className="prose prose-lg text-gray-300 bg-gray-800 rounded-lg p-6 md:max-w-[80%]" dangerouslySetInnerHTML={{__html:contentHtml}}/>
                
                <div className='my-12'>
            <a href="/blog"   className='p-4  bg-none border-2 border-primaryText text-sm  hover:shadow-[5px_5px_rgba(0,_98,_90,_0.4),_10px_10px_rgba(0,_98,_90,_0.3),_15px_15px_rgba(0,_98,_90,_0.2),_20px_20px_rgba(0,_98,_90,_0.1),_25px_25px_rgba(0,_98,_90,_0.05)] duration-500 ease-out text-primaryText rounded-lg'>Back to blogs</a>
            </div>
            </article>
            </div>
