      ...
      <div className="mt-[55px]  text-primaryText max-md:max-w-md justify-center items-center  flex flex-col gap-2">
        ...
        <div className="flex flex-row gap-12 justify-center items-center mt-2">
          <div>
            <div
              onClick={handleClick}
              className="relative inline-flex items-center justify-center px-10 py-4 overflow-hidden hover:cursor-pointer font-mono font-medium tracking-tighter text-white bg-gray-800 rounded-lg group"
            >
